...
export default function Board({data, questionNumber, setQuestionNumber, setTimeOut}) {
    ...
    const handleClick = (a) => {
        setSelectedAnswer(a);
        setClassName("min-w-[calc(50%-2rem)] flex-1 p-5 m-4 bg-gradient-to-b from-purple-900" +
        ...
        delay(3000, () => {
            setClassName(a.correct ? "animate-correct min-w-[calc(50%-2rem)] flex-1 p-5 m-4 " +
    ...
    return (
        <>
            <div className="h-1/2 relative">
                <div className="w-20 h-20 rounded-full border-4 border-white flex items-center
            ...
            <div className="h-1/2">
                <div className="h-full flex flex-col items-center justify-around gap-5">
                    <div className="w-80 bg-gradient-to-b  from-[#10053e] to-[#020009] text-center p-5 rounded-lg
                    border-2 border-white text-xl">{question?.question}</div>
